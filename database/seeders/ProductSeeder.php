...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        $products = [
            ...
            [1, 'Keratin Treatment Set',             'Smoothens and repairs damaged hair.',              1299.00, 'keratin_treatment.png', 1],
            [1, 'Argan Oil Shampoo',                 'Moisturizing shampoo for soft and shiny hair.',    399.00,  'argan_shampoo.png',     1],
            ...
            [2, 'Facial Cleanser',                  'Gentle cleanser for all skin types.',               299.00,  'facial_cleanser.png',   1],
            [2, 'Hydrating Toner',                  'Restores pH balance and refreshes skin.',           259.00,  'hydrating_toner.png',   0],
            [2, 'Vitamin C Serum',                  'Brightens and reduces dark spots.',                 799.00,  'vitamin_c_serum.png',   1],
            ...
            [3, 'Professional Hair Dryer',           'High-speed dryer for professional use.',          1599.00,  'hair_dryer.png',        1],
